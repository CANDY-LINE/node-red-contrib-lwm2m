  ...
  0: {
    ...
    9 : {
      ...
      value: {
        init() {
          return si.battery().then((info) => {
            this.batteryLevel = parseInt(info.percent);
          // }).then(() => {
          //   this.batteryTask = setInterval(() => {
          //     si.battery().then((info) => {
          //       this.batteryLevel = parseInt(info.percent);
          //     });
          //   }, 5 * 60 * 1000);
          });
        ...
        fini() {
          ...
          delete this.batteryTask;
        },
        /* Always synchronous */ get() {
    ...
    10 : {
      ...
      value: {
        init() {
          return si.mem().then((info) => {
            this.memoryFree = parseInt(info.free);
          // }).then(() => {
          //   this.memoryTask = setInterval(() => {
          //     si.mem().then((info) => {
          //       this.memoryFree = parseInt(info.free);
          //     });
          //   }, 5 * 60 * 1000);
        ...
        fini() {
          clearInterval(this.memoryTask);
          delete this.memoryTask;
        },
        /* Always synchronous */ get() {
